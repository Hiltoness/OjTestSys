...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    %>
    <a href="LLgoto?xuehao=<%=xuehao%>&timeorall=<%="all"%>&pattern=<%=pattern %>"><%=year3 %></a>
 <%} %>
  </div>
</div>
...
&conornew=<%="new" %>&kcbianhao=<%=beant2.getKcbianhao() %>&gonghao=<%=beant2.getGonghao() %>" class="aleft">开始答卷</a></td>
</tr>
<%} }%>
<%} %>
</table>
